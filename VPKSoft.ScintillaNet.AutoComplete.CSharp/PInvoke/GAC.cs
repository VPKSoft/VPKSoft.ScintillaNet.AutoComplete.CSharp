...
// Not a class I wrote, so disable code inspection..
...
namespace VPKSoft.ScintillaNet.AutoComplete.CSharp.PInvoke
{
    ...
    public class AssemblyCache
    {
        ...
        [DllImport("fusion.dll", SetLastError = true, CharSet = CharSet.Unicode, PreserveSig = false)]
        private static extern void GetCachePath(ASM_CACHE_FLAGS dwCacheFlags, [MarshalAs(UnmanagedType.LPWStr)] StringBuilder pwzCachePath,
            ref uint pcchPath);
